...
export function Navbar() {
  ...
  const innerContent = (
    <div
      ...
      style={{
        ...
        background: scrolled
          ? isDark ? "rgba(8,8,8,0.88)" : "rgba(250,250,250,0.88)"
          : "transparent",
        backdropFilter: scrolled ? "blur(24px)" : "none",
        WebkitBackdropFilter: scrolled ? "blur(24px)" : "none",
        border: scrolled ? "1px solid var(--border)" : (!isDark && mounted ? "1px solid var(--border)" : "none"),
  ...
  return (
    <>
      {/* Mobile: CSS animation puro — zero framer-motion bloqueando o paint inicial */}
      {isMobile ? (
        <header
